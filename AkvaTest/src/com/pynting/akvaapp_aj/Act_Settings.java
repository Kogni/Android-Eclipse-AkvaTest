...
public class Act_Settings extends Activity {
	...
	getWindow().getDecorView().setBackgroundColor(Color.rgb(0, 128, 128));
	...
	((TextView) localview_item5).addTextChangedListener(new TextWatcher() {
		...
		SpannableString contentText = new SpannableString(((TextView) localview_item5).getText());
		String ny = Html.toHtml(contentText).toString();
		ny = Html.fromHtml(ny).toString();
		ny = ny.replace("\n", "").replace("\r", "");
		ny = ny.toLowerCase();
		Log.i("-----Act_Settings", "Act_Settings onCreate onTextChanged ny=" + ny);
	...
	((TextView) localview_item6).addTextChangedListener(new TextWatcher() {
		...
		SpannableString contentText = new SpannableString(((TextView) localview_item6).getText());
		String ny = Html.toHtml(contentText).toString();
		ny = Html.fromHtml(ny).toString();
		ny = ny.replace("\n", "").replace("\r", "");
		ny = ny.toLowerCase();
