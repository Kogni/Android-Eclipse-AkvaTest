...
import com.pynting.akvaapp_aj.class_Aquarium;
...
public class Array_Fish_Singleton {
	...
	//Log.i("Array_Fish", "Array_Fish constructor FishNames_Sorted=" + FishNames_Sorted.length + " searchphrase=" + searchphrase);
	...
	try {
	    ...
	    input = classLoader.getResourceAsStream("com/pynting/akvaapp_aj/" + Fiskefil);
		...
		if (line.length() > 1) {
		    try {
			String genus = line.substring(0, line.indexOf("|"));
			genus = genus.toLowerCase();
			line = line.substring(line.indexOf("|") + 1);

			String species = genus.substring(genus.indexOf(" ") + 1);
			...
			double PH_survive_Min = Double.parseDouble(value);
			//Log.i("Array_Fish", "Array_Fish loadFishFile PH_survive_Min=" + PH_survive_Min);
			...
			double PH_survive_Max = Double.parseDouble(value);
			...
			//Log.i("Array_Fish", "Array_Fish loadFishFile Updated Temp_survive_Min=" + newFish.hashmap.get("Temp_survive_Min"));
	...
	//Log.i("Array_Fish", "Array_Fish search_insertSpecies " + newspecies.get_Genus() + " " + newspecies.get_Species() + " searchphrase="+searchphrase);
